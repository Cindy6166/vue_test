<template>
  <div>
    ...
    <h3>sum times Ten:{{$store.getters.bigSum}}</h3>
    ...
    <button @click="incrementOdd">increment if it is odd number</button>
    <button @click="incrementWait">wait a second then increment</button>
  </div>
</template>
